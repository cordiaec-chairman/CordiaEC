...
const STRINGS: Record<string, { en: string; ko: string }> = {
  ...
  "contact.infoTitle": { en: "Contact Information", ko: "연락처 정보" },
  "contact.email": { en: "Email", ko: "이메일" },
  "contact.phone": { en: "Phone", ko: "전화" },
  "contact.address": { en: "Address", ko: "주소" },
  "contact.addressValue": {
    en: "K-ACADEMIC DIFFUSION RESEARCH CENTER. 100 Inha-ro\nMichuhol-gu, Incheon 22212, KOREA.",
    ko: "인천광역시 미추홀구 인하로 100\n인하대학교 K-학술확산연구센터",
  },
  "contact.businessHours": { en: "Business Hours", ko: "업무 시간" },
  "contact.weekdays": { en: "Monday - Friday:", ko: "월요일 - 금요일:" },
  "contact.weekdaysTime": { en: "10:00 AM - 4:00 PM KST", ko: "오전 10:00 - 오후 4:00" },
  "contact.weekends": { en: "Saturday - Sunday:", ko: "토요일 - 일요일:" },
  "contact.weekendsClosed": { en: "Closed", ko: "휴무" },
  "contact.formTitle": { en: "Send us a Message", ko: "메시지 보내기" },
  "contact.formDesc": {
    en: "Have a question about our programs or want to explore partnership opportunities? We'd love to hear from you.",
    ko: "프로그램에 대한 궁금한 점이나 파트너십 기회에 관해 문의하고 싶으시다면 편하게 연락해 주세요.",
  },
  "contact.openFormBtn": { en: "Open Contact Form", ko: "문의 폼 열기" },
  "contact.expectTitle": { en: "What to expect:", ko: "안내 사항:" },
  "contact.expect1": { en: "Response within 24 hours during business days", ko: "영업일 기준 24시간 이내 답변" },
  "contact.expect2": { en: "Dedicated support for partnership inquiries", ko: "파트너십 문의 전담 지원" },
  "contact.expect3": { en: "Multilingual support available", ko: "다국어 지원 가능" },
  "contact.expect4": { en: "Follow-up consultation if needed", ko: "필요 시 후속 상담 안내" },
  // ContactModal
  "contact.modalTitle": { en: "Contact Us", ko: "문의하기" },
  "contact.modalDesc": {
    en: "We're here to help. Reach out to us with any questions or inquiries.",
    ko: "궁금한 점이나 문의사항이 있으시면 아래 양식을 작성해 주세요.",
  },
  "contact.labelName": { en: "Name", ko: "이름" },
  "contact.labelEmail": { en: "Email", ko: "이메일" },
  "contact.labelMessage": { en: "Message", ko: "문의 내용" },
  "contact.placeholderName": { en: "Your Name", ko: "이름을 입력해주세요" },
  "contact.placeholderEmail": { en: "Your Email", ko: "이메일 주소를 입력해주세요" },
  "contact.placeholderMessage": { en: "Your message...", ko: "문의 내용을 입력해주세요..." },
  "contact.btnCancel": { en: "Cancel", ko: "취소" },
  "contact.btnSubmit": { en: "Submit", ko: "제출" },
  "contact.btnSending": { en: "Sending...", ko: "전송 중..." },
  "contact.successTitle": { en: "Message Sent Successfully", ko: "문의 접수 완료" },
  "contact.successDesc": {
    en: "Thank you for contacting us. We'll get back to you soon!",
    ko: "문의해 주셔서 감사합니다. 빠른 시일 내에 답변 드리겠습니다!",
  },
  "contact.errorTitle": { en: "Failed to Send Message", ko: "문의 접수 실패" },
  "contact.errorDesc": { en: "Something went wrong. Please try again.", ko: "오류가 발생했습니다. 다시 시도해 주세요." },
  "contact.validationName": { en: "Name is required", ko: "이름을 입력해주세요" },
  "contact.validationNameMin": { en: "Name must be at least 2 characters", ko: "이름은 2글자 이상이어야 합니다" },
  "contact.validationEmail": { en: "Email is required", ko: "이메일을 입력해주세요" },
  "contact.validationEmailFormat": { en: "Please enter a valid email address", ko: "올바른 이메일 주소를 입력해주세요" },
  "contact.validationMessage": { en: "Message is required", ko: "문의 내용을 입력해주세요" },
  "contact.validationMessageMin": { en: "Message must be at least 10 characters", ko: "문의 내용은 10글자 이상이어야 합니다" },
};
